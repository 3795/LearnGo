...
import (
	"LearnGo/BlueNetdisc/code/tool/i18n"
	"fmt"
	"net/http"
)
...
func CustomWebResultI18n(request *http.Request, wrapper *CodeWrapper, item *i18n.Item, v ...interface{}) *WebResult {
	return CustomWebResult(wrapper, fmt.Sprintf(item.Message(request), v...))
}
